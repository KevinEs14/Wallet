...
class AddPagosPage extends StatefulWidget {
  @override
  _AddPagosPageState createState() => _AddPagosPageState();
}

class _AddPagosPageState extends State<AddPagosPage> {

  TextEditingController _monto = TextEditingController();
  String? tipoServicio;
  String? tipoMoneda;

  final List<String> servicios=["Luz", "Agua","Gas","Telefonia Movil","Internet","Seguros","Universidad"];
  final List<String> moneda=["Bolivianos", "Dolares"];

  String? id;
  Future createPagos(Pagos pagos)async{
    //Reference to document
    final docUser=FirebaseFirestore.instance.collection('pagos').doc();
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: DropdownButton<String>(
                            value: tipoServicio,
                            // isExpanded: true,
                            items: servicios.map(buildMenuItem).toList(),
